...
const styles = StyleSheet.create({
  ...
  visual: { height: 350, justifyContent: "center", marginTop: 52 },
  ...
  copy: { gap: spacing.sm, marginTop: 28 },
  ...
  footer: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginTop: "auto", paddingTop: spacing.lg },
